  ...
  return (
    <div className='flex flex-col min-w-screen h-screen items-center justify-center text-white '>
      ...
      <div className='bg-green-600sad pt-3 flex'>
        ...
        <label className='pl-2 w-26' htmlFor="length">Length : {length}</label>

        <input type="checkbox" id="numberAllowed" defaultChecked={numberAllowed} onChange={() => {
          setNumberAllowed((prev) => !prev);
        }}
        className='accent-amber-500 '/>
        <label htmlFor="numberAllowed" className='pl-1 pr-1.5'>Numbers</label>
        <input type="checkbox" id="charactersAllowed" defaultChecked={charactersAllowed} onChange={() => {
